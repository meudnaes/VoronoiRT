...
atmos, line, S_λ, α_tot = VoronoiRT.plotter(VoronoiRT.read_irregular(fname)..., θ, ϕ, fname)
# atmos, line, S_λ, α_tot = plotter(read_quantities(fname, periodic=true)..., θ, ϕ, fname)

VoronoiRT.write_top_intensity(atmos, line, S_λ, α_tot, θ, ϕ, "$(title)_disk_centre_1")
